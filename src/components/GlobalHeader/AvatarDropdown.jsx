...
import UpdatePasswordDialog from '@/pages/system/user/components/UpdatePasswordDialog';
import {defaultAvatar} from '../../../config/env';
      ...
      <React.Fragment>
        ...
        <span className={`${styles.action} ${styles.account}`}>
          <Avatar size="small" className={styles.avatar} alt="avatar"
                  icon={currentUser.avatar ? {defaultAvatar} : 'user'}
                  src={currentUser.avatar ? currentUser.avatar : {defaultAvatar}} />
          <span className={styles.name}>{currentUser.username}</span>
        </span>
        </HeaderDropdown>
        <UpdatePasswordDialog visible={updatePasswordVisible} currentUser={currentUser}
