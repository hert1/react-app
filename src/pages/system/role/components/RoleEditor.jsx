...
class RoleEditor extends Component {
  ...
  handleSubmit = () => {
    ...
    form.validateFields((err, fieldsValue) => {
      if (err) return;
      if (!fieldsValue.permissions || fieldsValue.permissions.length === 0) {
        ...
        <Card bordered={false}>
          <Form>
            <Row>
              <Col>
                <Form.Item {...this.formItemLayout} label={formatMessage({
                  ...
                  {getFieldDecorator('roleName', {
                    initialValue: formType === 'A' ? null : values.roleName,
                    rules: [
                      {
                        required: true,
              ...
              <Col>
                <Form.Item {...this.formItemLayout} label={formatMessage({
                  id: 'role.field.roleCode',
                })}>
                  {getFieldDecorator('roleCode', {
                    initialValue: formType === 'A' ? null : values.roleCode,
                  })(<Input placeholder={formatMessage({ id: 'component.placeholder.content' }, {
                    content: formatMessage({
                      id: 'role.field.roleCode',
                    }),
              ...
              <Col span={24}>
                <Card bordered={false} title={formatMessage({
                  ...
                  {getFieldDecorator('permissions', {
                    required: true,
                    initialValue: formType === 'A' ? null : values.permissions,
                  })(<RoleMenu />)}
                </Card>
              </Col>
            </Row>
