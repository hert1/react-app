        ...
        <Form>
          <Form.Item {...this.formItemLayout} label={formatMessage({
            ...
            {getFieldDecorator('account', {
              initialValue: formType === 'A' ? null : values.account,
              rules: [
                {
                  required: true,
          ...
          <Form.Item {...this.formItemLayout} label={formatMessage({
            ...
            {getFieldDecorator('nickname', {
              initialValue: formType === 'A' ? null : values.nickname,
              rules: [
                {
                  required: true,
                  message: formatMessage({ id: 'component.placeholder.content' }, {
         ...
         <Form.Item {...this.formItemLayout} label={formatMessage({
            ...
            {getFieldDecorator('roleId', {
              initialValue: formType === 'A' ? null : values.roleId,
              rules: [
                {
                  required: formType === 'A',
                  message: formatMessage({ id: 'component.placeholder.content' }, {
          ...
          <Form.Item {...this.formItemLayout} label={formatMessage({
            id: 'user.field.accountType',
          })}>
            {getFieldDecorator('accountType', {
              initialValue: formType === 'A' ? 3 : values.accountType,
            })(<Radio.Group>
              <Radio value={1}><FormattedMessage id='component.option.su_admin' /></Radio>
              <Radio value={2}><FormattedMessage id='component.option.admin' /></Radio>
              <Radio value={3}><FormattedMessage id='component.option.user' /></Radio>
            </Radio.Group>)}
          </Form.Item>
          <Form.Item {...this.formItemLayout} label={formatMessage({
